...
var chart2 = d3.select("#bar-chart2")
		.append("svg")
...
d3.json("bar-chart-axis-2.json", function(data) { // loading the data with the d3.json function
	...
	//////////////////////////////////
// 2. Linear gradient
var defs = chart2.append("defs"); // Step 1: Append the ‘def(inition)s’ and the gradient to the svg
